            ...
            <div className="row">
                <div className="col-12 col-xl-6">
                    <div className={styles.content}>
                        <h2 className={styles.head}>We Create The Art
                            Of Stylish Living
                            Stylishly</h2>
                        ...
                        <div className={styles.phone}>
                            ...
                            <div className={styles.phoneNumber}>
                                <div className={styles.number}>012345678</div>
                                <div className={styles.call}>Call Us Anytime</div>
                            </div>
                        </div>

                        <Button arrow bg="dark" title="Get Free Estimate" />
                    </div>
                </div>
                <div className="col-6 d-none d-xl-block">
                    <img src="../stylishImage.jpg" alt="" />
                </div>
            </div>
        </div>
    );
